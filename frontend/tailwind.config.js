  ...
  theme: {
    extend: {
      ...
      keyframes: {
        ...
        equalize: { "0%,100%": { transform: "scaleY(0.35)" }, "50%": { transform: "scaleY(1)" } },
        haloPulse: { "0%,100%": { opacity: "0.35", transform: "scale(1)" }, "50%": { opacity: "0.7", transform: "scale(1.08)" } },
        revealCard: { "0%": { opacity: "0", transform: "translateY(24px) scale(0.96)" }, "100%": { opacity: "1", transform: "translateY(0) scale(1)" } },
      },
      animation: {
        ...
        revealCard: "revealCard 0.6s cubic-bezier(0.22, 1, 0.36, 1)",
      },
    },
  },
  plugins: [],
