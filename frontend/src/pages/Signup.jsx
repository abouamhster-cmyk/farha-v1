  ...
  return (
    <div className="relative min-h-[calc(100vh-70px)] flex flex-col items-center justify-center px-4 sm:px-6 py-4 overflow-hidden bg-[#0C0F0E] text-white">
      ...
      <div className="relative z-10 w-full max-w-[440px] text-center">
        ...
        <h1 className="font-display text-2xl sm:text-3xl font-bold mb-1 drop-shadow-md">Bienvenue sur Farha</h1>
        <p className="text-white/70 text-xs sm:text-sm mb-6">Créez votre compte en 30 secondes</p>
        ...
        <div className="bg-[#0C0F0E]/80 border border-white/15 rounded-3xl p-5 sm:p-8 backdrop-blur-xl shadow-2xl text-left">
          {sent ? (
            <div className="bg-safran/10 border border-safran/30 rounded-2xl p-6 text-center">
              <div className="text-3xl mb-2">✉️</div>
              <h3 className="font-display font-bold text-base mb-1 text-safran">Vérifiez votre e-mail</h3>
            ...
            <>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div>
                  <label className="block text-xs font-semibold mb-1.5 text-white/80">Nom complet</label>
                  <input
                    type="text"
                    required
                    value={fullName}
              ...
              <div className="text-center mt-5 pt-4 border-t border-white/10 text-xs">
                <span className="text-white/60">Déjà un compte ? </span>
                <Link to="/connexion" className="text-safran font-bold hover:underline ml-1">
                  Se connecter
                </Link>
              </div>
            </>
