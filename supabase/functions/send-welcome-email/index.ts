...
// --- VOS VRAIS FICHIERS AUDIO LOCAUX AVEC ENCODAGE PROPRE ---
const AUDIO_CARDS = [
  {
    id: 1,
    title: "Soundtrack Reel TikTok",
    meta: "Darija Marocain · Raï Moderne",
    quote: "يا خويا هاد السيمانة زاهية، الصيف والشمس ولقاء الأحباب...",
    bg: "https://images.unsplash.com/photo-1511671782779-c97d3d27a1d4?auto=format&fit=crop&w=600&q=80",
  ...
  },
  {
    ...
    bg: "https://images.unsplash.com/photo-1518199266791-5375a83190b7?auto=format&fit=crop&w=600&q=80",
  ...
  },
  {
    ...
    bg: "https://images.unsplash.com/photo-1530103862676-de8c9debad1d?auto=format&fit=crop&w=600&q=80",
  ...
  },
  {
    ...
    bg: "https://images.unsplash.com/photo-1523240795612-9a054b0db644?auto=format&fit=crop&w=600&q=80",
  ...
  },
  {
    ...
    bg: "https://images.unsplash.com/photo-1519689680058-324335c77eba?auto=format&fit=crop&w=600&q=80",
...
const FAQ_ITEMS = [
  ...
  { q: "Les clips vidéos TikTok & Reels sont-ils disponibles ?", a: "Notre équipe travaille actuellement sur l'intégration des clips vidéos animés verticaux (9:16). Cette fonctionnalité sera déployée très prochainement et accessible à tous nos membres !" },
    ...
    <section className="relative overflow-hidden bg-[#0C0F0E] text-white">
      ...
      <div className="relative z-10 max-w-[1080px] mx-auto px-6 sm:px-8 flex flex-col items-center justify-center text-center pt-8 sm:pt-20 pb-16 sm:pb-24">
        ...
        <div className="inline-flex items-center gap-2 bg-white/10 border border-safran/50 backdrop-blur-md text-safran-bright px-4 py-2 rounded-full text-xs sm:text-sm font-bold uppercase tracking-wider mb-6 shadow-md">
          ...
          {"👑 LE STUDIO DE HAUTE COMPOSITION DU MONDE ARABE & MAGHRÉBIN"}
        </div>

        {/* Arabe Darija */}
        <p className="font-arabic text-safran text-2xl sm:text-3xl mb-4 opacity-95 drop-shadow">
          صوب موسيقاك والكليب ديالك فـ 3 دقايق
        </p>

        {/* TITRE EXCLUSIF SANS ERREUR DE SYNTAXE JSX */}
...
// --- CARTES TARIFS DYNAMIQUES AÉRÉES (max-w-[1280px]) ---
function Pricing() {
